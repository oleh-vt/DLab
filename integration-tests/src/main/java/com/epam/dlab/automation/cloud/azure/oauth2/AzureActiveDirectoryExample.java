...
public class AzureActiveDirectoryExample {
    ...
    public static void main(String... args) throws IOException, InterruptedException, ExecutionException {
        ApplicationTokenCredentials credentials = ApplicationTokenCredentials.fromFile(new File(ConfigPropertyValue.getAzureAuthFileName()));
        // Replace these with your client id and secret
        final String clientId = credentials.clientId();
